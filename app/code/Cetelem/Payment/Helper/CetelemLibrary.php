...
* http://www.cetelem.es/wps/portal/cetelem/publica/areadeserviciosweb/descargaDeDocumentacionYEjecutables
* 
* cetelem es titular de todos los derechos de propiedad intelectual e industrial
* del software.
* 
...
* 
* cetelem se reserva la posibilidad de ejercer las acciones legales que le
* correspondan para hacer valer sus derechos frente a cualquier infracción de
* los derechos de propiedad intelectual y/o industrial.
* 
* cetelem Servicios de Procesamiento, S.L., CIF B85955367
*/
namespace Cetelem\Payment\Helper;
 
class CetelemLibrary extends \Magento\Framework\App\Helper\AbstractHelper {
    ...
    public static function escribirLog($idLog, $texto, $activo) {
    	if($activo){
			$writer = new \Zend\Log\Writer\Stream(BP . '/var/log/cetelem.log');
			$logger = new \Zend\Log\Logger();
			$logger->addWriter($writer);
			
			$logger->info("Cetelem_".$idLog." - ".$texto);
    	}
    }
    ...
    public static function textDsResponse($codResp){
    	...
    	$textoRespuesta="cetelem - Error en el pago";
